  ...
  return (
    <div className='min-h-[766px] py-[50px] md:py-[100px] gap-[10px] flex items-center justify-center'>
      ...
      /> */}
        ...
        <div
          ref={cardRef1}
          className={`h-[523px] md:h-[initial] lg:h-[523px] md:w-[544px] lg:w-[400px] w-full flex flex-col items-center gap-[15px] lg:gap-[25px] lg:px-[40px] ${
          ...
          <span className='font-inter font-normal text-[13px] leading-[16px] lg:text-[15px] lg:leading-[18px] text-center text-[#212529]'>
        ...
        <div
          ref={cardRef2}
          className={`h-[566px] card2Bg md:w-[544px] lg:w-[400px] w-full flex flex-col items-center justify-center gap-[25px] px-10 lg:px-[40px] border-[13px] border-gray-500 ${
          ...
          <span className='font-inter font-normal text-[13px] leading-[16px] lg:text-[15px] lg:leading-[18px] text-center text-white'>
        ...
        <div
          ref={cardRef3}
          className={`h-[523px] lg:w-[400px] md:w-[544px] w-full flex flex-col items-center gap-[25px] lg:px-[40px] ${
