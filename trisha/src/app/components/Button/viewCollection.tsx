...
const ViewCollectionButton = ({
  ...
  return (
    <button
      ...
      className={`lg:h-[46px] min-h-[43px] lg:min-w-[240px] py-[12px] px-[48px] gap-[10px] bg-[#008080] hover:bg-[#104b4b] text-[#FFFFFF] text-[16px] lg:text-[18px] leading-[22px] text-center mt-6 transition duration-500 font-medium ${
